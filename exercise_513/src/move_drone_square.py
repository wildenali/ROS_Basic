...
if __name__ == '__main__':
  ...
  '''
Tahap PERTAMA (create file)
1. Buat folder src
2. Buat file move_drone_square.py di folder src
3. Terminal #1
    a. Eksekusi perintah chmod +x move_drone.py di folder exercise_513/src
    b. roscd; cd .. [ENTER]
4. Buat folder launch
5. Buat file move_drone_square.launch di folder launch
6. roscd; cd ..
7. catkin_make

Tahap KEDUA (rostopic pub)
1. Terminal #1
    a. roslaunch exercise_513 move_drone_square.launch
2. Terminal #2
    a.  rostopic pub /move_drone_square_as/goal actionlib/TestActionGoal [TAB][TAB] "header:
        seq: 0
        stamp:
            secs: 0
            nsecs: 0
        ...
        goal:
        goal: 0"
    b. Ubah nilai goal 0 menjadi 2, kemudian enter  // angka 2 ini hanya sebagai argument aja, nani di programnya di masukin ke dalam time.sleep, jadi semakin besar, maka kotak yg dibuat semakin besar pula
3. Terminal #3
    a. Cara cek feedback
