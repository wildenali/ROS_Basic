...
Tahap PERTAMA
1. Buat folder src
2. Buat file move_drone.py di folder src
3. Terminal #1
    a. Eksekusi perintah chmod +x move_drone.py di folder exercise_56/src
    b. roscd; cd .. [ENTER]
4. Buat folder launch
5. Buat file move_drone.launc di folder launch
6. Cek apakah Action Server sedang berjalan atau tidak, caranya di Terminal #1
    a. rostopic list | grep ardrone_action_server
    b. kalau muncul 
        ...
        berarti sudah jalan Action Server nya
    c. kalau tidak ada, jalankan roslaunch ardrone_as action_server.launch di Terminal #1 untuk menjalakan Action Server

Tahap KEDUA (roslaunch)
1. Terminal #2
    a. roslaunch exercise_56 move_drone.launch
    b. drone akan takeoff, 
    c. terus drone akan berputar sambil mengambil gambar
    d. drone akan landing
2. DONE
'''