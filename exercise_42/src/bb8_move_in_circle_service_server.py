...
Test yg PERTAMA
Terminal #1
    roscd exercise_42/src
    rosun exercise_42 bb8_move_in_circle_service_server.py
...
Test yg KEDUA
Terminal #1
    roscd exercise_42/launch
    roslaunch start_bb8_move_in_circle_service_server.launch
