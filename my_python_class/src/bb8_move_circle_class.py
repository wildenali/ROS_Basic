...
1. Buat file bb8_move_circle_class.py
2. Terminal #1
    a. Eksekusi perintah chmod +x bb8_move_circle_class.py di folder my_python_class/src
    b. roscd; cd .. [ENTER]
    c. rosrun my_python_class bb8_move_circle_class.py
'''