...
move_bb8_in_square_service_client = rospy.ServiceProxy('/move_bb8_in_square_custom', BB8CustomServiceMessage)   # Create the connection to service
...
# move_bb8_square_request_object.side = 1             # side ini adalah seberapa besar dia membuat sebuah kotak, minimal 1
# move_bb8_square_request_object.repetitions = 4      # harus kelipatan 4, karena sekali square itu 4 kali sudut gerakan
